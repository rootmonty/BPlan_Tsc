...
public class MainActivityOtp extends AppCompatActivity implements View.OnClickListener {
    ...
    private void confirmOtp() throws JSONException {
        ...
        buttonConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final ProgressDialog loading = ProgressDialog.show(MainActivityOtp.this, "Authenticating", "Please wait while we check the entered code", false, false);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.CONFIRM_URL,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                if (response.equalsIgnoreCase("success")) {
                                    ...
                                    startActivity(new Intent(MainActivityOtp.this, Success.class));
                                } else {
                                    //Displaying a toast if the otp entered is wrong
                                    Toast.makeText(MainActivityOtp.this, "Wrong OTP Please Try Again", Toast.LENGTH_LONG).show();
                                    try {
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                alertDialog.dismiss();
                                Toast.makeText(MainActivityOtp.this, error.getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }) {
                    @Override
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonResponse.getString(Config.TAG_RESPONSE).equalsIgnoreCase("Success")) {
                                ...
                                Toast.makeText(MainActivityOtp.this, "Username or Phone number already registered", Toast.LENGTH_LONG).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
