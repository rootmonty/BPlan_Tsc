...
public class Config {
    ...
    public static final String REGISTER_URL = "http://192.168.1.4/androidotp/register.php";
    public static final String CONFIRM_URL = "http://192.168.1.4/androidotp/confirm.php";
